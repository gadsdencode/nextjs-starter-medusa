...
return (
    ...
    <Select className="rounded-lg text-white" id="heater-type" label="Select Version" placeholder={undefined} nonce={undefined} onResize={undefined} onResizeCapture={undefined}>
