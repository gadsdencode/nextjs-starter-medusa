...
const SelectTrigger = React.forwardRef<React.ElementRef<typeof SelectPrimitive.Trigger>, SelectTriggerProps>(
  ({ className, id, children, ...props }, ref) => (
    <SelectPrimitive.Trigger ref={ref} id={id} className={cn("flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border border-input bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1", className)} {...props}>
      {children}
      ...
      <SelectPrimitive.Portal>
        <SelectPrimitive.Content
          ...
          className={cn(
            ...
            className // Updated to use cn function for merging class names
          )}
          {...props}
        >
